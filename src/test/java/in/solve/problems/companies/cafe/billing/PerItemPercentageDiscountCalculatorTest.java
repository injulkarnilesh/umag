...
public class PerItemPercentageDiscountCalculatorTest {
    ...
    public void shouldCalculateForEmptyBill() {
        ...
        final DiscountCalculator<Bill> calculator = PerItemPercentageDiscountCalculator.forItem(COFFEE, BigDecimal.TEN);
    ...
    public void shouldCalculateDiscountWithMatchingItem() {
        ...
        final DiscountCalculator<Bill> calculator = PerItemPercentageDiscountCalculator.forItem(COFFEE, BigDecimal.valueOf(10.00));

        final BigDecimal discount = calculator.calculate(bill);
        assertThat(discount, is(BigDecimal.valueOf(10.00).setScale(2)));
    }
    ...
    public void shouldCalculateForNonMatchingItem() {
        final Bill bill = BillBuilder.withItemsFrom(itemFactory)
                .addItems(TE, 2)
                .build();
        final DiscountCalculator<Bill> calculator = PerItemPercentageDiscountCalculator.forItem(COFFEE, BigDecimal.valueOf(5.00));
